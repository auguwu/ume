# i.noel.ws
[![Discord](https://discordapp.com/api/guilds/382725233695522816/embed.png)](https://discord.gg/yDnbEDH) [![Travis](https://travis-ci.org/nowoel/i.noel.ws.svg?branch=master)](https://travis-ci.org/github/nowoel/i.noel.ws)
...
### Process
- Fork the repository [here](https://github.com/nowoel/i.noel.ws/fork)
- Clone the forked repository (``git clone https://github.com/$USERNAME/i.noel.ws``)
